...
test.beforeEach(async ({ page }) => {
  ...
  await page.waitForTimeout(3000);
 await page.frameLocator(pageObject.grapfIframe).locator('.form-control').nth(5).fill("20");
   await page.frameLocator(pageObject.grapfIframe).locator('.form-control').nth(6).fill("100");
   await page.frameLocator(threePointPageObject. whole_Iframe).locator(threePointPageObject.btn_done).click();
    ...
    await page.waitForTimeout(4000);
    expect(page.frameLocator(pageObject.grapfIframe).locator('.form-control').nth(1)).toHaveValue("20");
    expect(page.frameLocator(pageObject.grapfIframe).locator('.form-control').nth(2)).toHaveValue("100");
    await page.waitForTimeout(4000);
