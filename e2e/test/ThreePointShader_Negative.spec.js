...
test('Design Mode to Post Test Mode --> SAD Flow', async ({ page }) => {    
    ...
    await (icon).click();
    await page.frameLocator(threePointPageObject. whole_Iframe).locator(threePointPageObject.XYinput_Box).nth(0).fill('15');
    await page.frameLocator(threePointPageObject. whole_Iframe).locator(threePointPageObject.XYinput_Box).nth(1).fill('25');
    await page.frameLocator(threePointPageObject. whole_Iframe).locator(threePointPageObject.XYinput_Box).nth(2).fill('35');
    await page.frameLocator(threePointPageObject. whole_Iframe).locator(threePointPageObject.XYinput_Box).nth(3).fill('45');
    await page.frameLocator(threePointPageObject. whole_Iframe).locator(threePointPageObject.XYinput_Box).nth(4).fill('55');
    await page.frameLocator(threePointPageObject. whole_Iframe).locator(threePointPageObject.XYinput_Box).nth(5).fill('65');
    ...
    expect(page.frameLocator(threePointPageObject. whole_Iframe).locator(threePointPageObject.threeShader_2)).toBeVisible();
